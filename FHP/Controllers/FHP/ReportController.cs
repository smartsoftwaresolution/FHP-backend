...
namespace FHP.Controllers.FHP
{
    ...
    public class ReportController : ControllerBase
    {
        ...
        [HttpGet("total-dashboardcount")]
        public async Task<IActionResult> GetAllCountAsync(string rolename)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorList());
            ...
            var response = new ResponseDashboardCounts<object>();

            try
            {

                var data = await _reportManager.GetAllCount(rolename);
